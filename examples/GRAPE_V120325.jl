...
# coding in Julia by Jean-Pierre Barriot, December 3, 2025
...
# for the algorithm in this code
#------------------------------------------------------------------------------------------------------------------------------------------------
...
# Gauss 5-stages implicit symplectic integrator
# Butcher's 1962 paper coefficients
...
# using SPICE # to be activated to use de430
td="$(now())"
...
order_parder_metric=4 # this defines the precision for the computation (2, 4, 6 or 8) of the numerical derivation of the metric / Christoffel symbols throughout the code
...
const epsabs_CSN=parse(BigFloat,"1.e-12")  # cte for numerical derivation of Christoffel symbols
const epsmin_CSN=parse(BigFloat,"1.e-50")  # cte for numerical derivation of Christoffel symbols
...
AU=parse(BigFloat,"149597870.700")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#mu=BF0 # to go back to Minkowski space-time in spherical coordinates, if needed for tests
...
if Given_Metric == Kerr_Metric_Polar_name
   ...
   # const as=BF0  # if needed for tests, to go back to a Schwarschild metric
...
y0_pt=fill(BF0,nsyst) # contravariant vector, initial state vector *wrt proper time* in chart coordinates
...
dtaudevpar_internal=der1_tau_internal(y0_pt,Kerr_Metric_Polar) # must be equal to unity for initial values wrt to proper time to be acceptable as an initial vector
